...
//        public static readonly Color MenuSelectedColor = Color.White;
...
//            buttonNamesFont = contentManager.Load<SpriteFont>("Fonts/ButtonNameFont");
...
//            hudDetailFont = contentManager.Load<SpriteFont>("Fonts/HudDetailsFont");
...
//        #region Drawing Helper Methods
        ...
        public static void DrawCenteredText(SpriteBatch spriteBatch, SpriteFont font,
            string text, Vector2 position, float scale, Color color)
        {
            // check the parameters
            if (spriteBatch == null)
            {
            ...
            var centeredPosition = new Vector2(
                position.X - (int)textSize.X / 2f,
                position.Y - (int)textSize.Y / 2f);
...
//        public static Vector2 GetCenterPositionInButton(SpriteFont font, string text, Rectangle buttonPosition)
//        {
//            Vector2 positionOfText = Vector2.Zero;

//            Vector2 fontSize = font.MeasureString(text);
//            positionOfText.X = (buttonPosition.X) + buttonPosition.Width / 2 - fontSize.X / 2;
//            positionOfText.Y = buttonPosition.Y + buttonPosition.Height / 2 - fontSize.Y / 2;
