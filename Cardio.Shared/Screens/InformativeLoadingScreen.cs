...
namespace Cardio.UI.Screens
{
    public class InformativeLoadingScreen: LoadingScreen
    {
        public static readonly IList<string> Information = new List<string>
        {
            ...
            "Total weight of all microbes and parasites in the body of an average human is greater than 1 kg.\r\nSome of them are vital.",
            "Average female heart weights 220g, male one - 280.\r\nWomen are affected by heart-related diseases generally in 10 years later than men are.",
            ...
            "80% of harmful microbes get into our body through the hands.\r\nSo, very useful kind of prophylaxis of colds and flu is washing the hands."
        };
        ...
        private bool _userClickedProceedButton = false;

        private GrowingMenuEntry _proceedButton;
        private bool _proceedButtonSelected;

        private GrowingMenuEntry _tweetButton;

        private GrowingMenuEntry _reenterPin;

        private bool _tweeted;
