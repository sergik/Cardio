...
namespace Cardio.Phone.Shared.Sounds
{
    public static class SoundManager
    {
        ...
        public static SoundEffect Heal { get; private set; }

        public static SoundEffect Tablet { get; private set; }

        public static SoundEffectInstance MenuMelody { get; private set; }
        ...
        public static void Initialize(Game game)
        {
            ...
            Tablet = content.Load<SoundEffect>(@"Sounds\Heal");
            MenuMelody = content.Load<SoundEffect>(@"Sounds\Melody1Level1").CreateInstance();
            MenuMelody.IsLooped = true;
        }
